...
const Button = ({ onClick, children }) => {
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between py-3 px-6 text-lg text-white rounded-lg transform -translate-y-1 bg-gradient-to-r from-[#00c6ff] via-[#0072ff] to-[#ff00a0] gap-3 transition duration-[600ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:-translate-y-1.5 group-hover:duration-[250ms] group-active:-translate-y-0.5 brightness-100 group-hover:brightness-110 shadow-[0_0_15px_rgba(0,198,255,0.4)] group-hover:shadow-[0_0_25px_rgba(255,0,160,0.6)]">

        {/* 2. CHANGE THIS LINE from "Start session" to {children} */}
        <span className="select-none font-bold tracking-wide">{children}</span>
